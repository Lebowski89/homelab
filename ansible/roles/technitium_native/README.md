...
| Var          | Type         | Value       |
|--------------|--------------|-------------|
| [technitium_native_install_script_url](defaults/main.yml#L3)   | str | `https://download.technitium.com/dns/install.sh` |    
| [technitium_native_install_script_path](defaults/main.yml#L4)   | str | `/tmp/technitium-dns-install.sh` |    
| [technitium_native_service_name](defaults/main.yml#L6)   | str | `dns` |    
| [technitium_native_web_port](defaults/main.yml#L7)   | int | `5380` |    
| [technitium_native_dns_port](defaults/main.yml#L8)   | int | `53` |    
| [technitium_native_config_dir](defaults/main.yml#L10)   | str | `/etc/dns` |    
| [technitium_native_install_marker](defaults/main.yml#L11)   | str | `/opt/technitium/dns/DnsServerApp.dll` |    
| [technitium_native_resolved_dns_servers](defaults/main.yml#L13)   | list | `[]` |    
| [technitium_native_resolved_dns_servers.**0**](defaults/main.yml#L14)   | str | `192.168.80.53` |    
| [technitium_native_resolved_dns_servers.**1**](defaults/main.yml#L15)   | str | `192.168.80.54` |    
| [technitium_native_disable_resolved_stub](defaults/main.yml#L17)   | bool | `True` |    
