...
| [netbox_domain](defaults/main.yml#L14)   | str |  |    
| [netbox_required_docker_secrets](defaults/main.yml#L16)   | dict | `{}` |    
| [netbox_required_docker_secrets.**netbox_superuser_email_secret**](defaults/main.yml#L17)   | str | `{{ netbox_superuser_email }}` |    
| [netbox_required_docker_secrets.**netbox_superuser_password_secret**](defaults/main.yml#L18)   | str | `{{ netbox_superuser_password }}` |    
| [netbox_required_docker_secrets.**netbox_db_user_secret**](defaults/main.yml#L19)   | str | `{{ netbox_postgres_user }}` |    
| [netbox_required_docker_secrets.**netbox_db_password_secret**](defaults/main.yml#L20)   | str | `{{ netbox_postgres_pass }}` |    
| [netbox_required_docker_secrets.**netbox_redis_password_secret**](defaults/main.yml#L21)   | str | `{{ netbox_redis_password }}` |    
| [netbox_docker_secrets](defaults/main.yml#L23)   | str | `{{ netbox_required_docker_secrets }}` |    
| [netbox_name](defaults/main.yml#L29)   | str | `netbox` |    
| [netbox_stack](defaults/main.yml#L30)   | str | `netbox` |    
| [netbox_compose_file](defaults/main.yml#L31)   | str | `netbox-compose.yml` |    
...
| [netbox_swarm_node_hostname](defaults/main.yml#L44)   | str | `{{ inventory_hostname }}` |    
| [netbox_docker_network](defaults/main.yml#L45)   | str | `overlay` |    
| [netbox_logging](defaults/main.yml#L47)   | dict | `{}` |    
| [netbox_logging.**driver**](defaults/main.yml#L48)   | str | `json-file` |    
| [netbox_logging.**options**](defaults/main.yml#L49)   | dict | `{}` |    
| [netbox_logging.options.**max-size**](defaults/main.yml#L50)   | str | `50m` |    
| [netbox_logging.options.**max-file**](defaults/main.yml#L51)   | str | `5` |    
| [netbox_logging.options.**compress**](defaults/main.yml#L52)   | str | `true` |    
| [netbox_restart_policy](defaults/main.yml#L54)   | dict | `{}` |    
| [netbox_restart_policy.**condition**](defaults/main.yml#L55)   | str | `on-failure` |    
| [netbox_restart_policy.**delay**](defaults/main.yml#L56)   | str | `10s` |    
| [netbox_restart_policy.**max_attempts**](defaults/main.yml#L57)   | int | `5` |    
...
| [netbox_postgres_puid](defaults/main.yml#L76)   | str | `999` |    
| [netbox_postgres_pgid](defaults/main.yml#L77)   | str | `999` |    
| [netbox_postgres_path](defaults/main.yml#L78)   | str | `{{ netbox_base_path }}/postgres` |    
| [netbox_postgres_db_name](defaults/main.yml#L79)   | str | `netbox` |    
| [netbox_traefik_enable](defaults/main.yml#L85)   | bool | `True` |    
| [netbox_traefik_dynamic_dir](defaults/main.yml#L86)   | str | `/opt/traefik/dynamic` |    
| [netbox_traefik_entrypoint](defaults/main.yml#L87)   | str | `https_private` |    
| [netbox_traefik_authelia_enable](defaults/main.yml#L88)   | bool | `False` |    
| [netbox_traefik_crowdsec_enable](defaults/main.yml#L89)   | bool | `False` |    
