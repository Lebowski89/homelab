...
| [postgres_etcd_initial_cluster_state](defaults/main.yml#L19)   | str | `new` |    
| [postgres_patroni_scope](defaults/main.yml#L25)   | str | `pg-cluster` |    
| [postgres_patroni_namespace](defaults/main.yml#L26)   | str | `/service` |    
| [postgres_patroni_node_name](defaults/main.yml#L27)   | str | `{{ inventory_hostname }}` |    
| [postgres_patroni_config_dir](defaults/main.yml#L29)   | str | `/etc/patroni` |    
| [postgres_patroni_config_path](defaults/main.yml#L30)   | str | `{{ postgres_patroni_config_dir }}/config.yml` |    
| [postgres_patroni_data_dir](defaults/main.yml#L31)   | str | `/var/lib/postgresql/{{ postgres_version }}/main` |    
| [postgres_patroni_bin_dir](defaults/main.yml#L32)   | str | `/usr/lib/postgresql/{{ postgres_version }}/bin` |    
| [postgres_patroni_restapi_port](defaults/main.yml#L33)   | int | `8008` |    
| [postgres_patroni_postgres_port](defaults/main.yml#L34)   | int | `5432` |    
| [postgres_patroni_superuser_name](defaults/main.yml#L40)   | str | `postgres` |    
| [postgres_patroni_superuser_pass](defaults/main.yml#L41)   | str |  |    
| [postgres_patroni_replication_name](defaults/main.yml#L43)   | str | `replicator` |    
| [postgres_patroni_replication_pass](defaults/main.yml#L44)   | str |  |    
| [postgres_patroni_admin_role_name](defaults/main.yml#L46)   | str | `admin` |    
| [postgres_patroni_admin_role_pass](defaults/main.yml#L47)   | str |  |    
| [postgres_patroni_admin_role_login](defaults/main.yml#L48)   | bool | `True` |    
| [postgres_patroni_admin_role_createdb](defaults/main.yml#L49)   | bool | `True` |    
| [postgres_patroni_admin_role_createrole](defaults/main.yml#L50)   | bool | `False` |    
| [postgres_patroni_etcd_hosts](defaults/main.yml#L52)   | list | `[]` |    
| [postgres_patroni_pg_hba_extra](defaults/main.yml#L53)   | list | `[]` |    
| [postgres_uptime_kuma_monitor_role_name](defaults/main.yml#L59)   | str | `uptime_kuma_monitor` |    
| [postgres_uptime_kuma_monitor_role_pass](defaults/main.yml#L60)   | str |  |    
| [postgres_uptime_kuma_monitor_database](defaults/main.yml#L61)   | str | `postgres` |    
| [postgres_backup_root](defaults/main.yml#L67)   | str | `/var/backups/postgresql` |    
| [postgres_backup_script_path](defaults/main.yml#L68)   | str | `/usr/local/sbin/postgres-logical-backup` |    
| [postgres_backup_manage_timer](defaults/main.yml#L69)   | bool | `False` |    
| [postgres_backup_timer_name](defaults/main.yml#L70)   | str | `postgres-logical-backup` |    
| [postgres_backup_timer_on_calendar](defaults/main.yml#L71)   | str | `*-*-* 03:00:00` |    
| [postgres_backup_timer_randomized_delay_sec](defaults/main.yml#L72)   | str | `30m` |    
| [postgres_backup_local_retention_days](defaults/main.yml#L73)   | int | `7` |    
| [postgres_backup_failed_retention_days](defaults/main.yml#L74)   | int | `2` |    
| [postgres_backup_metrics_file](defaults/main.yml#L75)   | str | `/var/lib/node_exporter/textfile_collector_postgres/postgres_logical_backup.prom` |    
| [postgres_backup_remote_manage](defaults/main.yml#L81)   | bool | `False` |    
| [postgres_backup_remote_enabled](defaults/main.yml#L82)   | bool | `False` |    
| [postgres_backup_remote_restic_path](defaults/main.yml#L83)   | str | `/usr/bin/restic` |    
| [postgres_backup_remote_script_path](defaults/main.yml#L84)   | str | `/usr/local/sbin/postgres-logical-backup-remote` |    
| [postgres_backup_remote_state_dir](defaults/main.yml#L85)   | str | `/var/lib/postgres-logical-backup-remote` |    
| [postgres_backup_remote_repository](defaults/main.yml#L86)   | str |  |    
| [postgres_backup_remote_config_dir](defaults/main.yml#L87)   | str | `/etc/restic/postgres-logical-backup` |    
| [postgres_backup_remote_repository_file](defaults/main.yml#L88)   | str | `{{ postgres_backup_remote_config_dir }}/repository` |    
| [postgres_backup_remote_password_file](defaults/main.yml#L89)   | str | `{{ postgres_backup_remote_config_dir }}/password` |    
| [postgres_backup_remote_environment_file](defaults/main.yml#L90)   | str | `{{ postgres_backup_remote_config_dir }}/backend.env` |    
| [postgres_backup_remote_managed_secret_files_manifest](defaults/main.yml#L91)   | str | `<multiline value: folded_strip>` |    
| [postgres_backup_remote_password_secret](defaults/main.yml#L93)   | dict | `{}` |    
| [postgres_backup_remote_password_secret.**path**](defaults/main.yml#L94)   | str | `/Restic/Postgres` |    
| [postgres_backup_remote_password_secret.**name**](defaults/main.yml#L95)   | str | `PASSWORD` |    
| [postgres_backup_remote_backend_environment](defaults/main.yml#L96)   | dict | `{}` |    
| [postgres_backup_remote_backend_secrets](defaults/main.yml#L97)   | list | `[]` |    
| [postgres_backup_remote_secret_files](defaults/main.yml#L98)   | list | `[]` |    
| [postgres_backup_remote_options](defaults/main.yml#L99)   | list | `[]` |    
| [postgres_backup_remote_retry_lock](defaults/main.yml#L100)   | str | `10m` |    
| [postgres_backup_remote_timer_name](defaults/main.yml#L101)   | str | `postgres-logical-backup-remote` |    
| [postgres_backup_remote_timer_on_calendar](defaults/main.yml#L102)   | str | `*-*-* 04:00:00` |    
| [postgres_backup_remote_timer_randomized_delay_sec](defaults/main.yml#L103)   | str | `30m` |    
| [postgres_backup_remote_maintenance_timer_name](defaults/main.yml#L104)   | str | `postgres-logical-backup-remote-maintenance` |    
| [postgres_backup_remote_maintenance_timer_on_calendar](defaults/main.yml#L105)   | str | `Sun *-*-* 05:00:00` |    
| [postgres_backup_remote_maintenance_timer_randomized_delay_sec](defaults/main.yml#L106)   | str | `30m` |    
| [postgres_backup_remote_maintenance_host](defaults/main.yml#L107)   | str | `<multiline value: folded_strip>` |    
| [postgres_backup_remote_snapshot_host](defaults/main.yml#L109)   | str | `{{ postgres_patroni_scope }}` |    
| [postgres_backup_remote_keep_daily](defaults/main.yml#L110)   | int | `14` |    
| [postgres_backup_remote_keep_weekly](defaults/main.yml#L111)   | int | `8` |    
| [postgres_backup_remote_keep_monthly](defaults/main.yml#L112)   | int | `12` |    
| [postgres_backup_remote_metrics_file](defaults/main.yml#L113)   | str | `<multiline value: folded_strip>` |    
| [postgres_backup_restore_validation_manage](defaults/main.yml#L120)   | bool | `False` |    
| [postgres_backup_restore_validation_enabled](defaults/main.yml#L121)   | bool | `False` |    
| [postgres_backup_restore_validation_host](defaults/main.yml#L122)   | str | `{{ postgres_backup_remote_maintenance_host }}` |    
| [postgres_backup_restore_validation_script_path](defaults/main.yml#L123)   | str | `/usr/local/sbin/postgres-logical-backup-restore-validate` |    
| [postgres_backup_restore_validation_runuser_path](defaults/main.yml#L124)   | str | `/usr/sbin/runuser` |    
| [postgres_backup_restore_validation_work_root](defaults/main.yml#L125)   | str | `/var/lib/postgres-logical-backup-restore-validation` |    
| [postgres_backup_restore_validation_timer_name](defaults/main.yml#L126)   | str | `postgres-logical-backup-restore-validation` |    
| [postgres_backup_restore_validation_timer_on_calendar](defaults/main.yml#L127)   | str | `Sun *-*-* 07:00:00` |    
| [postgres_backup_restore_validation_timer_randomized_delay_sec](defaults/main.yml#L128)   | str | `30m` |    
| [postgres_backup_restore_validation_port](defaults/main.yml#L129)   | int | `55432` |    
| [postgres_backup_restore_validation_max_snapshot_age_hours](defaults/main.yml#L130)   | int | `48` |    
| [postgres_backup_restore_validation_min_free_bytes](defaults/main.yml#L131)   | int | `5368709120` |    
| [postgres_backup_restore_validation_encoding](defaults/main.yml#L132)   | str | `UTF8` |    
| [postgres_backup_restore_validation_locale](defaults/main.yml#L133)   | str | `C.UTF-8` |    
| [postgres_backup_restore_validation_metrics_file](defaults/main.yml#L134)   | str | `<multiline value: folded_strip>` |    
| [postgres_restore_dbs_dir](defaults/main.yml#L141)   | str | `/tmp` |    
| [postgres_restore_dbs_drop_existing](defaults/main.yml#L142)   | bool | `True` |    
| [postgres_restore_dbs_map](defaults/main.yml#L147)   | list | `[]` |    
| [postgres_fix_owner_map](defaults/main.yml#L162)   | list | `[]` |    
