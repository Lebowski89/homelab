...
NESTED_PATHS = {
    ...
    "deploy.execution.host_user",
    "deploy.execution.userns",
    "deploy.execution.userns.mode",
    "deploy.execution.userns.uid",
    "deploy.execution.userns.gid",
    "deploy.host",
    "deploy.mode",
    "deploy.replicas",
    "deploy.profile",
